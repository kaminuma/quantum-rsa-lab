"""N=143, a=34, r=4 の最適化量子回路

N=143 (= 11 x 13) を r=4 で因数分解。
...
【因数分解】
gcd(34^2 - 1, 143) = gcd(11, 143) = 11
gcd(34^2 + 1, 143) = gcd(13, 143) = 13
∴ 143 = 11 × 13

【ポイント】
N=35 → N=143 で 4倍大きな数を、同一の回路複雑度で因数分解。
"""
