"""N=185, a=6, r=4 の最適化量子回路

N=185 (= 5 x 37) を r=4 で因数分解。
...
【因数分解】
gcd(6^2 - 1, 185) = gcd(35, 185) = 5
gcd(6^2 + 1, 185) = gcd(37, 185) = 37
∴ 185 = 5 × 37

【ポイント】
N=35 → N=185 で 5.3倍大きな数を、同一の回路複雑度で因数分解。
"""
